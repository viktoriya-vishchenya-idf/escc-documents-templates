...
#linebreak()
- En ningún caso el pago mensual mínimo será menor a la suma de los
  siguientes conceptos: (i) el importe mayor de las siguientes cifras: 5
  euros o 1,85% del importe principal del préstamo, restando los intereses
  devengados y las comisiones de reclamación de cuota impagada; más (ii)
  los intereses correspondientes al periodo de liquidación; más (iii) el
  pago mínimo de la facturación anterior, si estuviese impagada; más (iv)
  la penalización por impago del periodo de liquidación#emph[.]
