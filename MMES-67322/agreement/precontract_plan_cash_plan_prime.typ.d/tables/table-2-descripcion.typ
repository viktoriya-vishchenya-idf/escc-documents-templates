...
#figure(
  align(center)[#table(
    ...
    el Prestamista concederá la línea de crédito al consumo mediante #marked[la puesta a disposición] de la totalidad del Importe Actual en la #marked[Cuenta de Crédito del Prestatario] abierta en la App Plazo
    #marked[o en la cuenta bancaria facilitada]
    por este.
    ...
    + En el supuesto de #marked[modificación del límite de crédito, el
      ...
      de Usuario de la Aplicación móvil, (i)
