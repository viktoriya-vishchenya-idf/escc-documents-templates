...
#let datos-del-contrato(vars) = [
    ...
    Mercantil de Barcelona, al tomo / IRUS: 1000380036447, folio 0, Hoja
    B-558505
    ...
    #underline[1500 EUR] dispuesto en su totalidad en una única disposición (sin
    más disposiciones) el mismo día que contrata la Línea de Crédito (por
    ...
    devolver hasta amortizar el crédito en 48 meses sería de 2271,59€,] mediante
    47 cuotas de 47,31 más una última cuota de 48,02 euros, que es el importe
    ...
    #ruled-doc-table(
      ...
      table.cell()[
        ...
        #strong[será superior a] #underline[#strong[5000 Euros.]]
      ],
    )
    ...
    #second-col-ruled-doc-table(
      ...
      table.cell()[
        #deg-item[
          ...
          #linebreak()
          #strong[25 Euros] o #strong[3%] #strong[del importe principal]
          dispuesto; #underline[#strong[más]]
        ]
      ],
      // row 2
    ...
    #emph[Supuesto de Límite de Crédito de #underline[1500 EUR] dispuesto en su
    ...
    de] #underline[#strong[pago mínimo seria 47,31]] #strong[(comprensiva de
    ...
    mínimo en 48 meses sería de 2271,59€,] mediante 47 cuotas de 47,31 más una
    última cuota de 48,02 euros, que es el importe que resulta de la diferencia
