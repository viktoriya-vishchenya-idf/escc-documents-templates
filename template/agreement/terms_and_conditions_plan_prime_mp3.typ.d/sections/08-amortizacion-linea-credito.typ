...
#let clause-08-amortizacion-linea-credito(vars) = [
    ...
    #bullet-list[
      - #marked[25 Euros o 3% del importe principal dispuesto, incluyendo los
        intereses devengados y excluyendo las penalizaciones por impago más]
    ...
    recurrentes que sean necesarios tanto en la cuenta que tenga en la
    #underline[App Plazo], en las tarjetas de pago indicadas o bien en la Cuenta
    Corriente de Domiciliación hasta que el importe correspondiente a las
    comisiones, cuotas mensuales o cuotas mensuales vencidas sea liquidado.]
    ...
    #dash-list[
      ...
      - UNNAX REGULATORY SERVICES EDE, S.L., (“Unnax”) es una entidad de dinero
        ...
        #link("mailto:atencionalcliente@unnax.com")[atencionalcliente\@unnax.com].
    ]

    El Prestamista no almacena los datos de tarjetas bancarias sin previa
