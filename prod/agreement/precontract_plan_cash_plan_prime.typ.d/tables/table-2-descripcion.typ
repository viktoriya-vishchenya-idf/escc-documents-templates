...
#figure(
  align(center)[#table(
    ...
    - Y un #marked[máximo]; que IDFinance Plazo ofrece al Cliente a través de banca electrónica (App o web), previo análisis creditico y de solvencia.En ningún caso el límite asignado al Cliente será superior a #marked[5.000 Euros].
    ];
    ...
    ], [Una vez que el contrato de línea de crédito se haya formalizado,
    el Prestamista concederá la línea de crédito al consumo mediante #marked[la puesta a disposición] de la totalidad
    del Importe Actual en la #marked[Cuenta de Crédito del Prestatario] abierta en la App Plazo
    #marked[o en la cuenta bancaria facilitada] por este.
    ...
    + #marked[Previo análisis de la solvencia] por parte del Prestamista de la
      variación de las circunstancias que motivaron la concesión del
      Crédito (como puede ser, de conformidad con la Política de Crédito
      interna, el reducción significativa del poder adquisitivo del
    ...
    + En el supuesto de #marked[modificación del límite de crédito, el
      ...
      de Usuario de la Aplicación móvil de la entidad colaboradora, (i)
    ...
    + #marked[*Pago revolving*]~mediante #marked[*cuota de Pago Mínimo:*]
      ...
      *El importe del pago mínimo se calcula cada mes como la suma
      ...
      + el #underline[importe mayor de] las siguientes cifras: (i)
        *#underline[5 €] ,* #underline[o] (ii)
        *#underline[1.85% del importe principal dispuesto];*; más

      + *los intereses devengados* correspondientes al periodo de
        liquidación, más
...
//        table.cell(fill: table-header-fill.lign)
        [#emph[Supuesto de Límite de Crédito de #underline[1.500 EUR]
        ...
        amortizar el crédito en 48 meses sería de 2269,44€,* mediante 47
        cuotas de 47,32€, más una última cuota de
        45,58€, que es el importe que resulta de la diferencia
