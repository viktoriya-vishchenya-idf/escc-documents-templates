...
#import "../common/default_styles.typ": table-header-fill, marked, dashList, dashList09spacing
...
#figure(
  align(center)[#table(
    ...
    *aplica al Contrato de Crédito #underline[(TIN)];*]
    ...
    El tipo deudor se calcula a partir del número de días reales en un
    mes natural y un año de 365 días.
    ...
    *Advertencia:* *#underline[Una TAE elevada implica un
    ...
    [#nested-table(
        ...
        table.hline(),
        [Supuesto de Límite de Crédito de #underline[1.500 EUR]
        ...
        amortizar el crédito en 48 meses sería de 2269,44 € ,* mediante
        47 cuotas de 47,32 más una última cuota de 45,58 euros, que es
        ...
        #underline[1.500 EUR] dispuesto en su totalidad en una única
        ...
        *El total a devolver con pago anticipado*, por ejemplo,
        al final del primer mes “01/05/2025D” (30 días), seria de
        1527,59 .];],
      )
